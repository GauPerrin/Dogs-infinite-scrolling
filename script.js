...
function displayPhotos(){
    ...
    photosArray.forEach((photo) => {
        // We use the Json data we can get in the console log 
        ...
        img.setAttribute('alt', photo.alt_descriptions);
        img.setAttribute('title', photo.alt_descriptions);
        // Event listener,check when eachis finished loading
        img.addEventListener('load', imageLoaded);


        // Put <img> inside <a> and then put them both inside imageContainer Element
